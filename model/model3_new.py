...
class DoubleNet(nn.Module):
    ...
    def forward(self, x, y,z):
        ...
        z1, fea3, t3 = self.embeddingnet(z)
        ...
        wxz = wxz.view(wxz.size(0), wxz.size(1), -1)
        #print(wxy)
        #print(wxy.shape)
        res1 = x2.mul(wxy)
        res2 = y2.mul(wxy)
        ...
        res3 = res3.view(res3.size(0), res3.size(1), 7, 7)
        res4 = res4.view(res4.size(0), res4.size(1), 7, 7)
        ...
        res3 = self.pool(res3)
        res3 = res3.view(res3.size(0), res3.size(1))
        res4 = self.pool(res4)
        res4 = res4.view(res4.size(0), res4.size(1))
        ...
        return fea1,fea2,fea3,res1, res2,res3,res4
...
class Net(nn.Module):
    ...
    def forward(self, x):
        ...
        #     a = x[0, i, :, :]
        #     a = a.squeeze()
        #     ori,_,_ = draw_features(a.cpu().data.numpy(), origi,i)
